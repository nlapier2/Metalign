...
def profile_parseargs():  # handle user arguments
	...
	parser.add_argument('--db', default='NONE', help='Path to database from select_db.py. Required if read files given')
	...
	parser.add_argument('--rank_renormalize', action='store_true',
		help='Renormalize abundances to 100% at each rank, e.g if an organism has a species but not genus label.')
