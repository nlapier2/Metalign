...
def parseargs():  # handle user arguments
	...
	parser.add_argument('reads', nargs='+',
		help='Reads file or comma-delimited list of reads files. Required.')
	parser.add_argument('db',
		help='Location of .fna database generated by select_db.py. Required.')
...
def compute_abundances(args, samfile, acc2info, tax2info):
	...
	# run mapping and process to get uniq map abundances and multimapped reads
	taxids2abs, multimapped, total_bases = map_and_process(args, samfile,
															acc2info, tax2info)
...
def write_results(args, rank_results):
	with(open(args.output, 'w')) as outfile:
		...
		if args.sampleID == 'NONE':
			outfile.write('@SampleID:' + ','.join(args.reads) + '\n')
		else:
