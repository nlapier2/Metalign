...
def metalign_parseargs():  # handle user arguments
    ...
    parser.add_argument('--rank_renormalize', action='store_true',
                        help='Renormalize abundances to 100 percent at each rank,for instance if an organism has a '
...
def main():
    ...
    if args.dbinfo_in == 'AUTO':
        # TODO: doesn't assign value to anything (peterk87: Wed Jan 22 10:14:22 CST 2020)
